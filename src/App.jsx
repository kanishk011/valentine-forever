...
const steps = [
  ...
  { id: 3, component: LoveLetter, name: 'letter' },
  { id: 4, component: LoveCards, name: 'cards' },
  { id: 5, component: Countdown, name: 'countdown' },
  { id: 6, component: FinalSurprise, name: 'final' },
];
